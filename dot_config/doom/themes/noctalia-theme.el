...
(let* ((bg "#111411")
      ...
      (on-primary "#003916")
      (on-primary-container "#a1f6ad")
      (on-secondary "#233425")
      (on-secondary-container "#d3e8d1")
      (on-surface "#e2e3dd")
      (on-surface-variant "#c1c9be")
      (on-tertiary "#00363e")
      (on-tertiary-container "#bdeaf4")
      (outline-color "#8b9389")
      (outline-variant "#414941")
      (primary "#85d993")
      (primary-container "#005322")
      (secondary "#b8ccb6")
      (secondary-container "#394b3a")
      (shadow "#000000")
      (surface "#111411")
      ...
      (tertiary "#a1ced7")
      (tertiary-container "#1f4d55")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#a1ced7")
      (on-success "#00363e")
      (success-container "#1f4d55")
      (on-success-container "#bdeaf4")
      ;; Map fixed colors to regular colors
      (primary-fixed "#85d993")
      (primary-fixed-dim "#005322")
      (secondary-fixed "#b8ccb6")
      (secondary-fixed-dim "#394b3a")
      (tertiary-fixed "#a1ced7")
      (tertiary-fixed-dim "#1f4d55")
      (on-primary-fixed "#003916")
      (on-primary-fixed-variant "#a1f6ad")
      (on-secondary-fixed "#233425")
      (on-secondary-fixed-variant "#d3e8d1")
      (on-tertiary-fixed "#00363e")
      (on-tertiary-fixed-variant "#bdeaf4")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#e2e3dd")
      (inverse-primary "#85d993")
      (inverse-surface "#111411")
